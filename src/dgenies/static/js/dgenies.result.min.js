...
if(!d3||!d3.dgenies){throw"d3.dgenies wasn't included!"}d3.dgenies.mousetip={};d3.dgenies.mousetip.dotplot={};d3.dgenies.mousetip.track_x={};d3.dgenies.mousetip.track_y={};/**
...
let match=null;let found=false;let x_track=d3.dgenies.y_track.data;for(let x_id in x_track){for(let feat of x_track[x_id]){let f_start=feat[0];let f_len=feat[1];if(f_start<=c_y&&c_y<=f_start+f_len){match={contig:x_id,feature:feat};found=true;break}}if(found){break}}return match};
