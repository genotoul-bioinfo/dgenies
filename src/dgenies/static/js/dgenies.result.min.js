 ...
 * @param {Event} e
 * @returns {boolean}
 */d3.dgenies.zoom.isModKey=function(e){const isMac=/Mac|iPod|iPhone|iPad/.test(navigator.platform);return isMac?e.metaKey:e.ctrlKey};/**
 ...
 * Click event action
 */d3.dgenies.zoom.click=function(){if(!d3.dgenies.zoom.isModKey(d3.event)&&!d3.dgenies.all_disabled){let cursor=d3.dgenies.zoom._cursor_pos();d3.dgenies.select_zone(cursor[0],cursor[1])}};/**
