 ...
 */d3.dgenies.draw_background=function(x_order,y_order){let x_zones=d3.dgenies.x_zones,y_zones=d3.dgenies.y_zones;const x_background=["rgba(255,255,255,0)",d3.dgenies.x_background_color];// d3.dgenies.x_pickr.getColor().toRGBA().toString()
...
$("path.content-lines").remove();for(let i=0;i<4;i++){d3.dgenies.__draw_idy_lines(i.toString(),lines,x_len,y_len)}d3.dgenies.events.filter_size(d3.dgenies.min_size)};d3.dgenies.create_pickr=function(el,default_color="#FFFFFF00"){return new Pickr({el:el,default:default_color,theme:"nano",lockOpacity:false,swatches:["rgba(244, 67, 54, 0.2)","rgba(233, 30, 99, 0.2)","rgba(156, 39, 176, 0.2)","rgba(103, 58, 183, 0.2)","rgba(63, 81, 181, 0.2)","rgba(33, 150, 243, 0.2)","rgba(3, 169, 244, 0.2)","rgba(0, 188, 212, 0.2)","rgba(0, 150, 136, 0.2)","rgba(76, 175, 80, 0.2)","rgba(139, 195, 74, 0.2)","rgba(205, 220, 57, 0.2)","rgba(255, 235, 59, 0.2)","rgba(255, 193, 7, 0.2)"],components:{palette:false,preview:false,opacity:false,hue:false,interaction:{hex:false,rgba:false,hsva:false,input:false,clear:true,save:false}}})};d3.dgenies.add_restore_all=function(){let draw=$("#draw");draw.append($("<div>").attr("class","restore-all").html(`
