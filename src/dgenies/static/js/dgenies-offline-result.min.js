 ...
 * Initialise tooltip for dotplot
 */d3.dgenies.mousetip.track_x.init=function(){$("svg.top-track").mousetip_track_x(".tip","#draw")};/**
...
let rect=$("svg.top-track")[0].getBoundingClientRect();let posX=rect.left+window.scrollX,posY=rect.top+window.scrollY,width_c=rect.width,height_c=rect.height;console.log(posX,posY,width_c,height_c);// Transform into coordinates in data
let c_x=(e.pageX-posX)/width_c*d3.dgenies.scale;c_x=c_x/d3.dgenies.scale*d3.dgenies.x_len;let error_x=d3.dgenies.content_lines_width/d3.dgenies.scale*d3.dgenies.x_len;// let error_x = 0,
 ...
 * Initialise tooltip for dotplot
 */d3.dgenies.mousetip.track_y.init=function(){$("svg.right-track").mousetip_track_y(".tip","#draw")};/**
...
let rect=$("svg.right-track")[0].getBoundingClientRect();let posX=rect.left+window.scrollX,posY=rect.top+window.scrollY,width_c=rect.width,height_c=rect.height;console.log(posX,posY,width_c,height_c);// Transform into coordinates in data
