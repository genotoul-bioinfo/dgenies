...
d3.dgenies.zoom_top_track();d3.dgenies.zoom_right_track();d3.dgenies.zoom_enabled=false}$("#restore-all").show();dgenies.hide_loading()},0)};/**
 ...
 */d3.dgenies.set_right_track_color_tmpl=function(){if(d3.dgenies.y_track.type=="wig"){let color_theme=d3.dgenies.color_idy[d3.dgenies.color_idy_theme]["track_heatmap"];d3.dgenies.right_track_color=d3.scaleSequential().interpolator(color_theme).domain(d3.dgenies.y_track.range)}else{d3.dgenies.right_track_color=d3.dgenies.color_idy[d3.dgenies.color_idy_theme]["track_color"]}};/**
 * Set track color template for top track
 */d3.dgenies.set_top_track_color_tmpl=function(){if(d3.dgenies.x_track.type=="wig"){let color_theme=d3.dgenies.color_idy[d3.dgenies.color_idy_theme]["track_heatmap"];d3.dgenies.top_track_color=d3.scaleSequential().interpolator(color_theme).domain(d3.dgenies.x_track.range)}else{d3.dgenies.top_track_color=d3.dgenies.color_idy[d3.dgenies.color_idy_theme]["track_color"]}};/**
...
d3.dgenies.draw_top_axis();d3.dgenies.draw_right_axis();d3.dgenies.zoom_bottom_axis();d3.dgenies.zoom_left_axis();d3.dgenies.zoom_top_track(new_scale);d3.dgenies.zoom_right_track(new_scale);if(translate_x<=0.00001&&translate_x>=-0.00001&&translate_y<=0.00001&&translate_y>=-0.00001&&new_scale===1){$("#restore-all").hide()}else{$("#restore-all").show()}}}else if(d3.dgenies.zoom_enabled){let help_zoom=$("#help-zoom");help_zoom.fadeIn("slow");if(d3.dgenies.zoom.help_timeout!==null){window.clearTimeout(d3.dgenies.zoom.help_timeout)}d3.dgenies.zoom.help_timeout=window.setTimeout(()=>{help_zoom.fadeOut("slow")},700)}};/**
