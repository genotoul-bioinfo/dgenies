...
d3.dgenies.container_axis_thickness=5;d3.dgenies.container_track_thickness=3;d3.dgenies.container_dotplot_width=100-d3.dgenies.container_axis_thickness-d3.dgenies.container_track_thickness;d3.dgenies.container_dotplot_height=d3.dgenies.container_dotplot_width;//Filter sizes:
 ...
 * Draw top track
 */d3.dgenies.draw_top_track=function(){let svg_top=d3.dgenies.svgsupercontainer.append("svg:svg").attr("class","top-track").attr("width",d3.dgenies.container_dotplot_width-d3.dgenies.container_axis_thickness).attr("height",d3.dgenies.container_track_thickness).attr("x",d3.dgenies.container_axis_thickness).attr("y",d3.dgenies.container_axis_thickness).attr("viewBox","0 0 "+d3.dgenies.scale+" 1000").attr("preserveAspectRatio","none");svg_top.append("rect").attr("x",0).attr("y",0).attr("width","100%").attr("height","100%").attr("fill","#ffffff").attr("stroke","black");d3.dgenies.top_track_container=svg_top.append("svg:g").attr("class","top-track-container");if(d3.dgenies.x_track!=null){d3.dgenies.set_top_track_color_tmpl();let x_track=d3.dgenies.x_track.data;for(let x_id in x_track){for(let feat of x_track[x_id]){let f_start=feat[0];let f_len=feat[1];let f_val=feat[2];let f_comment=feat[3];let start=f_start/d3.dgenies.x_len*d3.dgenies.scale;length=f_len/d3.dgenies.x_len*d3.dgenies.scale;let block=d3.dgenies.top_track_container.append("rect").attr("x",start).attr("y",0).attr("width",length).attr("height","100%").attr("stroke","none").attr("class","track").attr("fill",d3.dgenies.top_track_color(d3.dgenies.set_track_color(f_val))).attr("fill_origin",f_val)}}}};/**
 * Draw right track
 */d3.dgenies.draw_right_track=function(){let svg_right=d3.dgenies.svgsupercontainer.append("svg:svg").attr("class","right-track").attr("width",d3.dgenies.container_track_thickness).attr("height",d3.dgenies.container_dotplot_height-d3.dgenies.container_axis_thickness).attr("x",d3.dgenies.container_dotplot_width).attr("y",d3.dgenies.container_axis_thickness+d3.dgenies.container_track_thickness).attr("viewBox","0 0 1000 "+d3.dgenies.scale).attr("preserveAspectRatio","none");svg_right.append("rect").attr("x",0).attr("y",0).attr("width","100%").attr("height","100%").attr("fill","#ffffff").attr("stroke","black");d3.dgenies.right_track_container=svg_right.append("svg:g").attr("class","right-track-container");if(d3.dgenies.y_track!=null){d3.dgenies.set_right_track_color_tmpl();let y_track=d3.dgenies.y_track.data;for(let y_id in y_track){for(let feat of y_track[y_id]){let f_start=feat[0];let f_len=feat[1];let f_val=feat[2];let f_comment=feat[3];let start=(d3.dgenies.y_len-f_start-f_len)/d3.dgenies.y_len*d3.dgenies.scale;let length=f_len/d3.dgenies.y_len*d3.dgenies.scale;let block=d3.dgenies.right_track_container.append("rect").attr("x",0).attr("y",start).attr("width","100%").attr("height",length).attr("stroke","none").attr("class","track").attr("fill",d3.dgenies.right_track_color(d3.dgenies.set_track_color(f_val))).attr("fill_origin",f_val)}}}};/**
 * Zoom top track
 * 
 ...
 */d3.dgenies.events.stroke_width=function(width){let stroke_width=d3.dgenies.scale/600;if(width==="1"){stroke_width=d3.dgenies.scale/400}else if(width==="2"){stroke_width=d3.dgenies.scale/200}else if(width==="3"){stroke_width=d3.dgenies.scale/100}d3.dgenies.content_lines_width=stroke_width;d3.selectAll("path.content-lines").attr("stroke-width",stroke_width/d3.dgenies.zoom_scale_lines)};if(!d3||!d3.dgenies){throw"d3.dgenies wasn't included!"}d3.dgenies.mousetip={};/**
