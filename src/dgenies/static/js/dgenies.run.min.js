...
let tool=$("input[name=tool]:checked").val();input_type="query";input_file=$(`input#${input_type}`).val();if(input_file.length===0){if(!dgenies.run.tool_has_ava[tool]){$(`label.file-${input_type}`).addClass("error");$(`label.file-${input_type}-ava`).addClass("error");dgenies.run.add_error("Query fasta is required!");has_errors=true}}else if(input_file.startsWith("example://")){let res=dgenies.run.check_example(input_type,input_file);if(!res.valid){has_errors=true;$(`label.file-${input_type}`).addClass("error");dgenies.run.add_error(`Query fasta: ${res.message}`)}}}/* TAB 2 */else if(tab==="tab2"){// manage backup
input_type="backup";input_file=$(`input#${input_type}`).val();if(input_file.length!==0){dgenies.run.reset_file_form("tab2",true);if(input_file.startsWith("example://")){let res=dgenies.run.check_example(input_type,input_file);if(!res.valid){has_errors=true;$(`label.file-${input_type}`).addClass("error");dgenies.run.add_error(`Backup file: ${res.message}`)}}}else{input_type="targetidx";input_file=$(`input#${input_type}`).val();if(input_type.val().length===0){$(`label.file-${input_type}`).addClass("error");dgenies.run.add_error("Target file is required!");has_errors=true}else if(input_file.startsWith("example://")){let res=dgenies.run.check_example(input_type,input_file);if(!res.valid){has_errors=true;$(`label.file-${input_type}`).addClass("error");dgenies.run.add_error(`Target file: ${res.message}`)}}input_type="queryidx";input_file=$(`input#${input_type}`).val();if(input_file.startsWith("example://")){let res=dgenies.run.check_example(input_type,input_file);if(!res.valid){has_errors=true;$(`label.file-${input_type}`).addClass("error");dgenies.run.add_error(`Query file: ${res.message}`)}}input_type="alignfile";input_file=$(`input#${input_type}`).val();if(input_file.length===0){$(`label.file-${input_type}`).addClass("error");dgenies.run.add_error("Alignment file is required!");has_errors=true}else if(input_file.startsWith("example://")){let res=dgenies.run.check_example(input_type,input_file);if(!res.valid){has_errors=true;$(`label.file-${input_type}`).addClass("error");dgenies.run.add_error(`Alignment file: ${res.message}`)}}}}/* TAB 3 */else{//Check input target:
