...
if(dgenies.run.file_states.some(element=>element==="available")){has_uploads=true;// TODO: show progress bar.
dgenies.run.hide_file_state("available-file");dgenies.run.show_loading("available-file")}}return has_uploads};/**
