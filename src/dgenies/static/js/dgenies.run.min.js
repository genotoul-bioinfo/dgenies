 ...
 */dgenies.run.refresh_html_listing=function(){let list=[];for(let i=0;i<dgenies.run.files_for_batch.length;i++){let data={"name":dgenies.run.files_for_batch[i].files[0].name,"size":dgenies.run.files_for_batch[i].files[0].size,"state":dgenies.run.file_states[i]};list.push(data)}// We update the html part
 ...
 **/dgenies.run.check_files=function(){let uploaded_files=dgenies.run.get_uploaded_files();dgenies.run.file_states=dgenies.run.check_uploaded_files(dgenies.run.files_in_batch,uploaded_files);dgenies.run.missing_files=dgenies.run.check_missing_files(dgenies.run.files_in_batch,uploaded_files)};/**
...
dgenies.run.files_for_batch.push(data);// We refresh batch status
...
let has_batch_error=false;for(error of dgenies.run.batch_errors){has_batch_error=has_batch_error||error.severity=="error"}if(has_batch_error){dgenies.run.add_error("Batch file is incorrect");has_errors=has_batch_error}// Check that no file in batch file is missing
