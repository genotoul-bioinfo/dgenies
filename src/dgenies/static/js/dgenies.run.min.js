 ...
 */dgenies.run.show_tab=function(tab){$(`#tabs #${tab}`).addClass("active");$(`#tabs .tab:not(#${tab})`).removeClass("active");$(`.tabx:not(${tab})`).hide();$(`.tabx.${tab}`).show();if(tab==="tab3"&&dgenies.run.editor===null){// delayed init else style broken
