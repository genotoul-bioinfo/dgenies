 ...
 */dgenies.run.init=function(s_id,allowed_ext,max_upload_file_size=1073741824,target_example="",query_example="",batch_example="",tool_has_ava={}){dgenies.run.s_id=s_id;dgenies.run.allowed_ext=allowed_ext;dgenies.run.max_upload_file_size=max_upload_file_size;dgenies.run.target_example=target_example;dgenies.run.query_example=query_example;dgenies.run.batch_example=batch_example;dgenies.run.tool_has_ava=tool_has_ava;dgenies.run.restore_form();dgenies.run.set_events();dgenies.run.init_fileuploads()};/**
 * Restore run form
 ...
 * Initialise events
 */dgenies.run.set_events=function(){let ftypes=["query","target","alignfile","queryidx","targetidx","backup","batch"];$.each(ftypes,function(i,ftype){dgenies.run._set_file_event(ftype);dgenies.run._set_file_select_event(ftype)});$("button#submit").click(function(){dgenies.run.submit()});$("button#example_align").click(function(){dgenies.run.fill_examples("tab1")});$("button#example_batch").click(function(){dgenies.run.fill_examples("tab3")});$("#tabs .tab").click(function(){dgenies.run.show_tab($(this).attr("id"))});$("input[name=tool]").click(function(){dgenies.run.show_tool_options($(this).val())})};/**
